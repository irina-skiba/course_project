...
- #### Git-репозиторий
  - README.md должен содержать: описание задания, инструкцию по запуску, ссылку на SonarCloud, при необходимости — структуру проекта.
  - Должен использоваться корректно настроенный .gitignore.
- #### SonarCloud
  - Требования: 0 bugs, 0 vulnerabilities, 0 code smells (или минимально возможное количество).
  - Статус Quality Gate — Passed.
- #### Качество именования
  - Имена классов, методов и переменных должны быть осмысленными и оформленными в едином стиле.
